...
class Gui():
	...
	def buttongui(self):
		...
		self.cancal=Button(self.botframe,padx=16,bd=8,fg='black',font=('arial',18,'bold'),text="cancel",bg="powder blue", command=self.cancel)
	...
	def cancel(self):
		...
		self.screemgui()
		# self.cancal.config(state='disabled')
